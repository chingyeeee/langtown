const knowledgeTestArray = [
  ...
  },
  {
    ...
    answer: "D",
    detail:
      "(A)貓科卡里西病毒 (FCV) 是貓咪身上常見的病毒之一，其症狀包括鼻腔分泌物、牙齦炎及口腔潰瘍。通常貓咪感染後，會需要數週到數個月的時間才能完全康復。</br>(B)很多人對冠狀病毒有很深的誤解，覺得冠狀病毒=腹膜炎，但冠狀病毒其實是個高傳染低發病低突變的病毒。</br>(C)貓瘟是由貓小病毒(Feline Parvovirus)感染所引起的病毒性傳染病，會抑制骨髓的造血細胞，尤其此類病毒的適應力強，可存在環境中長達數年。",
  },
  {
    number: "問題六",
  ...
  },
  {
    ...
    answer: "B",
    detail:
      "(A)市面上有許多寵物保險，但記得多看看、多比較，同時留意醫療理賠制度、理賠次數上限等部分<br />(C)約7歲時身體便開始退化<br />(D)貓咪年紀越大，越容易出現各種老化的跡象，也容易有口腔疾病的發生",
  },
];
